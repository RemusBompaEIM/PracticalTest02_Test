...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serverPortEditText = (EditText)findViewById(R.id.server_port_textedit);
        connectButton = (Button)findViewById(R.id.button_connect);
        connectButton.setOnClickListener(connectButtonClickListener);

        clientAddressEditText = (EditText)findViewById(R.id.adr_client_textedit);
        clientPortEditText = (EditText)findViewById(R.id.port_client_textedit);
        cityEditText = (EditText)findViewById(R.id.oras_textedit);
